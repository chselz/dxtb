...
This module implements the short-ranged bond correction. The Shortranged class is
constructed similar to the Repulsion class.

Example
-------
The following example demonstrates how to use the short-ranged bond correction with
...
.. code-block:: python
    ...
    from dxtb.classical import new_shortranged
    ...
    # Instantiate the short-ranged bond correction class and the IndexHelper
    xb = new_shortranged(numbers, positions, GFN0_XTB)
...
from .factory import new_shortranged
from .srb import LABEL_SHORTRANGED, Shortranged

__all__ = ["new_shortranged", "Shortranged", "LABEL_SHORTRANGED"]
